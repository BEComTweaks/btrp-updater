                                        ...
                                        if (!fuckedUpCombinations) {
                                            if (e.startsWith(" ")) { // pack
                                                ...
                                                if (indexed[e] === undefined) {
                                                    if (flattened["categories"][currentCategory.id][e] === undefined) {
                                                        logger(`${e} isn't a valid pack`)
                                                        invalid = true;
                                                    } else {
                                                        currentCategory.packs.push(flattened["categories"][currentCategory.id][e])
                                                    }
                                                } else {
...
function upload() {
    request.name = document.querySelector(".packName").value;
    console.log(request);
